...
void hadafs_env_init(int id){
        if (hadafs_mount ("test",id) == -1){
                printf("VMP mounting failed\n");
                exit(1);
        }
}
#endif
...
int main(int argc, char **argv)
{
	...
	//fprintf(stdout, "start: %s", CurrentTimeString());
#endif
                              ...
                              int access)
{
	...
	//fprintf(stdout, "before mpicheck %-10d\n", rank);
	...
	//fprintf(stdout, "after mpicheck %-10d\n", rank);
