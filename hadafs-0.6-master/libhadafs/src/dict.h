...
HF_MUST_CHECK dict_t *dict_new (void);
dict_t *dict_copy_with_ref (dict_t *this,
			    dict_t *new);

HF_MUST_CHECK int dict_get_int8 (dict_t *this, char *key, int8_t *val);
HF_MUST_CHECK int dict_set_int8 (dict_t *this, char *key, int8_t val);

HF_MUST_CHECK int dict_get_int16 (dict_t *this, char *key, int16_t *val);
HF_MUST_CHECK int dict_set_int16 (dict_t *this, char *key, int16_t val);

HF_MUST_CHECK int dict_get_int32 (dict_t *this, char *key, int32_t *val);
HF_MUST_CHECK int dict_set_int32 (dict_t *this, char *key, int32_t val);

HF_MUST_CHECK int dict_get_int64 (dict_t *this, char *key, int64_t *val);
HF_MUST_CHECK int dict_set_int64 (dict_t *this, char *key, int64_t val);

HF_MUST_CHECK int dict_get_uint16 (dict_t *this, char *key, uint16_t *val);
HF_MUST_CHECK int dict_set_uint16 (dict_t *this, char *key, uint16_t val);

HF_MUST_CHECK int dict_get_uint32 (dict_t *this, char *key, uint32_t *val);
HF_MUST_CHECK int dict_set_uint32 (dict_t *this, char *key, uint32_t val);

HF_MUST_CHECK int dict_get_uint64 (dict_t *this, char *key, uint64_t *val);
HF_MUST_CHECK int dict_set_uint64 (dict_t *this, char *key, uint64_t val);

HF_MUST_CHECK int dict_get_double (dict_t *this, char *key, double *val);
HF_MUST_CHECK int dict_set_double (dict_t *this, char *key, double val);

HF_MUST_CHECK int dict_set_static_ptr (dict_t *this, char *key, void *ptr);
HF_MUST_CHECK int dict_get_ptr (dict_t *this, char *key, void **ptr);
HF_MUST_CHECK int dict_set_ptr (dict_t *this, char *key, void *ptr);
HF_MUST_CHECK int dict_set_dynptr (dict_t *this, char *key, void *ptr, size_t size);

HF_MUST_CHECK int dict_get_bin (dict_t *this, char *key, void **ptr);
HF_MUST_CHECK int dict_set_bin (dict_t *this, char *key, void *ptr, size_t size);
HF_MUST_CHECK int dict_set_static_bin (dict_t *this, char *key, void *ptr, size_t size);

HF_MUST_CHECK int dict_set_str (dict_t *this, char *key, char *str);
HF_MUST_CHECK int dict_set_dynstr (dict_t *this, char *key, char *str);
HF_MUST_CHECK int dict_get_str (dict_t *this, char *key, char **str);
