...
#define HF_DEFAULT_IBVERBS_LISTEN_PORT 6997

/* Perhaps these should be larger for a high
 * speed link like IB.
 */
#define HF_DEFAULT_IBV_WINDOW_SIZE   (512 * HF_UNIT_KB)
#define HF_MAX_IBV_WINDOW_SIZE       (1 * HF_UNIT_MB)
#define HF_MIN_IBV_WINDOW_SIZE       (128 * HF_UNIT_KB)
...
/* context per device, stored in global hadafs_ctx_t->ib */
