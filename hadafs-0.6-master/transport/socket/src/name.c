                                    ...
                                    socklen_t *sockaddr_len)
{
        ...
        if (remote_port_data == NULL)
        {
                hf_log (this->xl->name, HF_LOG_TRACE,
                        ...
                        this->xl->name, HF_DEFAULT_SOCKET_LISTEN_PORT);

                remote_port = HF_DEFAULT_SOCKET_LISTEN_PORT;
        }
        else
        {
                                    ...
                                    socklen_t *sockaddr_len)
{
        ...
        if (strlen (connect_path) > UNIX_PATH_MAX) {
                hf_log (this->xl->name, HF_LOG_ERROR,
                        "connect-path value length %"HF_PRI_SIZET" > %d octets", 
                                   ...
                                   socklen_t *addr_len)
{
        ...
        if (listen_port == (uint16_t) -1)
                listen_port = HF_DEFAULT_SOCKET_LISTEN_PORT;
