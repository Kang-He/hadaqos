...
#define HF_DEFAULT_SOCKET_LISTEN_PORT 6996
 ...
 * two iobufs + the HADAFS protocol headers.
 ...
 * IB links.
 */
#define HF_DEFAULT_SOCKET_WINDOW_SIZE   (512 * HF_UNIT_KB)
#define HF_MAX_SOCKET_WINDOW_SIZE       (1 * HF_UNIT_MB)
#define HF_MIN_SOCKET_WINDOW_SIZE       (128 * HF_UNIT_KB)
